# Magpie parent (Grok Bot)

Paste this skill into Grok Bot (Settings → Plugins → save-from-chat / Teach a task /
enable under Plugins → Yours). Do **not** assume a GitHub URL installer works for
