# Evaluation: CAMPAIGN-04-T03

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: MIGRATE-02 proof
Evidence level claimed: L1/L4-sim
...
Fence reject + uncertain effect crash window tests
...
MIGRATE-02 proof → code under `src/durable/**` + durable tests.
