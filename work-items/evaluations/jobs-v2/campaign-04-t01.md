# Evaluation: CAMPAIGN-04-T01

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: ADAPTER-01..04
Evidence level claimed: L6
...
durable CLI adapter; cancel/status/tick due exit 4
...
ADAPTER-01..04 → code under `src/durable/**` + durable tests.
