# Evaluation: CAMPAIGN-01-T04

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: STORE-06
Evidence level claimed: L1/L6
...
Prototype validate/import/archive; never schedule malformed
...
STORE-06 → code under `src/durable/**` + durable tests.
