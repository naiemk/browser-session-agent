# Evaluation: CAMPAIGN-02-T03

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: EXEC-04,06,07,09
Evidence level claimed: L0/L2
...
ContextCompiler, retry families, oracle vs claim
...
EXEC-04,06,07,09 → code under `src/durable/**` + durable tests.
