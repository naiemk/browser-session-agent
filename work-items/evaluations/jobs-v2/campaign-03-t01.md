# Evaluation: CAMPAIGN-03-T01

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: CASE-01..05
Evidence level claimed: L1/L2
...
Materialize seeds/cases; idempotent discovery; revision API
...
CASE-01..05 → code under `src/durable/**` + durable tests.
