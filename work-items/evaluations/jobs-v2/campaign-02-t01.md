# Evaluation: CAMPAIGN-02-T01

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: SCHED-01..08
Evidence level claimed: L0/L3
...
Pure SchedulerPolicy; runtime_unavailable; human timer non-wake
...
SCHED-01..08 → code under `src/durable/**` + durable tests.
