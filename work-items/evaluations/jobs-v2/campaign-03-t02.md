# Evaluation: CAMPAIGN-03-T02

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: EFFECT-01..06
...
Effect journal + envelope; uncertain on crash-after-dispatch
...
EFFECT-01..06 → code under `src/durable/**` + durable tests.
