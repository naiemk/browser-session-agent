# Evaluation: CAMPAIGN-03-T03

Date: 2026-09-09
Implementer: Auto (Composer)
Spec IDs: HUMAN-01..03
Evidence level claimed: L2/L3
...
Challenge HumanRequest + shared resource breaker
...
HUMAN-01..03 → code under `src/durable/**` + durable tests.
