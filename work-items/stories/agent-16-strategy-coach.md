...
All four tickets done, cited COACH-* IDs have tests, FakePi `/coach` works, a calibration
job materializes the three-step graph, and no harvest prompt contains a scout transcript.
